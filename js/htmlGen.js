    ...
    loadData().then((data) => {
        ...
        jsonData.data.forEach(j => {
            ...
            if (j.isPaper) htmldata +=
                `<a href="${j.paperLink}" role="button" class="p-1 btn btn-outline-secondary" id="paper">
            ...
            if (j.gotCode) htmldata +=
                `<a href="${j.codeLink}" role="button" class="p-1 btn btn-outline-secondary" id="paper">
            ...
            if (j.gotDemo) htmldata +=
                `<a href="${j.demoLink}" role="button" class="p-1 btn btn-outline-secondary" id="paper">
            ...
            if (j.gotWebpage) htmldata +=
                `<a href="${j.pageLink}" role="button" class="p-1 btn btn-outline-secondary" id="paper">
            ...
            if (j.gotDataset) htmldata +=
                `<a href="${j.dataLink}" role="button" class="p-1 btn btn-outline-secondary" id="paper">
