    ...
    loadData().then((data) => {
        ...
        jsonData.data.forEach(j => {
            ...
            var htmldata =
                ...
                `    <div class="col-md" >` +
                `        <div class="h-100 p-5 rounded text-bg-dark zoom" style="background-image: url('picture/${j.image}'); background-position: center;">` +
                `            <h2 class="text-center">${j.title}</h2>` +
                `            <p class="text-center">${j.abstract}</p>` +
                `         <div class="d-flex justify-content-center gap-2 mb-3">`

            if (j.isPaper) htmldata +=
                `<a href="${j.paperLink}" role="button" class="p-1 btn btn-outline-light" id="paper">
            ...
            if (j.gotCode) htmldata +=
                `<a href="${j.codeLink}" role="button" class="p-1 btn btn-outline-light" id="paper">
            ...
            if (j.gotDemo) htmldata +=
                `<a href="${j.demoLink}" role="button" class="p-1 btn btn-outline-light" id="paper">
            ...
            if (j.gotWebpage) htmldata +=
                `<a href="${j.pageLink}" role="button" class="p-1 btn btn-outline-light" id="paper">
            ...
            if (j.gotDataset) htmldata +=
                `<a href="${j.dataLink}" role="button" class="p-1 btn btn-outline-light" id="paper">
